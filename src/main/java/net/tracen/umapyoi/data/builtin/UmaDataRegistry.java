...
public class UmaDataRegistry {
    ...
    public static void registerAll(BootstapContext<UmaData> bootstrap) {
        ...
        bootstrap.register(OGURI_CAP, UmaData.createNewUmamusume("oguri_cap", GachaRanking.SR, new int[] {20, 0, 10, 0, 0}));
        bootstrap.register(SAKURA_CHIYONO_O, UmaData.createNewUmamusume("sakura_chiyono_o", GachaRanking.SR, new int[] {10, 0, 0, 10, 10}));
        bootstrap.register(OGURI_CAP_XMAS, UmaData.createNewUmamusume("oguri_cap", GachaRanking.SSR, new int[] {15, 15, 0, 0, 10}));
        bootstrap.register(AGNUS_TACHYON, UmaData.createNewUmamusume("agnus_tachyon", GachaRanking.SR, new int[] {20, 0, 0, 10, 0}));
        bootstrap.register(HARU_URARA, UmaData.createNewUmamusume("haru_urara", GachaRanking.SR, new int[] {0, 0, 10, 20, 0}));
        bootstrap.register(TAMAMO_CROSS, UmaData.createNewUmamusume("tamamo_cross", GachaRanking.SR, new int[] {0, 20, 10, 0, 0}));
        bootstrap.register(SEIUN_SKY, UmaData.createNewUmamusume("seiun_sky", GachaRanking.SR, new int[] {0, 10, 0, 0, 20}));
        bootstrap.register(MATIKANEFUKUKITARU, UmaData.createNewUmamusume("matikanefukukitaru", GachaRanking.SR, new int[] {0, 20, 10, 0, 0}));
        bootstrap.register(RICE_SHOWER, UmaData.createNewUmamusume("rice_shower", GachaRanking.SR, new int[] {0, 10, 0, 20, 0}));
        bootstrap.register(VODKA, UmaData.createNewUmamusume("vodka", GachaRanking.SR, new int[] {10, 0, 20, 0, 0}));
        bootstrap.register(SAKURA_BAKUSHIN_O, UmaData.createNewUmamusume("sakura_bakushin_o", GachaRanking.SR, new int[] {20, 0, 0, 0, 10}));
        bootstrap.register(MANHATTAN_CAFE, UmaData.createNewUmamusume("manhattan_cafe", GachaRanking.SR, new int[] {0, 30, 0, 0, 0}));
        bootstrap.register(MEJIRO_ARDAN, UmaData.createNewUmamusume("mejiro_ardan", GachaRanking.SR, new int[] {10, 0, 0, 0, 20}));
        bootstrap.register(DAITAKU_HELIOS, UmaData.createNewUmamusume("daitaku_helios", GachaRanking.SR, new int[] {15, 0, 15, 0, 0}));
        bootstrap.register(SWEEP_TOSHO, UmaData.createNewUmamusume("sweep_tosho", GachaRanking.SR, new int[] {10, 0, 20, 0, 0}));
        bootstrap.register(GOLD_CITY, UmaData.createNewUmamusume("gold_city", GachaRanking.SR, new int[] {0, 0, 10, 20, 0}));
        bootstrap.register(GOLD_SHIP_WATER, UmaData.createNewUmamusume("gold_ship", GachaRanking.SSR, new int[] {0, 0, 20, 0, 20}));
        bootstrap.register(MR_CB, UmaData.createNewUmamusume("mr_cb", GachaRanking.SR, new int[] {10, 10, 0, 0, 10}));
        bootstrap.register(GRASS_WONDER, UmaData.createNewUmamusume("grass_wonder", GachaRanking.SR, new int[] {20, 0, 10, 0, 0}));
        bootstrap.register(CURREN_CHAN, UmaData.createNewUmamusume("curren_chan", GachaRanking.SR, new int[] {10, 0, 20, 0, 0}));
        bootstrap.register(SILENCE_SUZUKA, UmaData.createNewUmamusume("silence_suzuka", GachaRanking.SR, new int[] {20, 0, 0, 10, 0}));
        bootstrap.register(TAMAMO_CROSS_FESTIVAL, UmaData.createNewUmamusume("tamamo_cross", GachaRanking.SSR, new int[] {15, 10, 0, 15, 0}));
        bootstrap.register(ASTON_MACHAN, UmaData.createNewUmamusume("aston_machan", GachaRanking.SR, new int[] {20, 0, 0, 10, 0}));
        bootstrap.register(KITASAN_BLACK, UmaData.createNewUmamusume("kitasan_black", GachaRanking.SR, new int[] {20, 10, 0, 0, 0}));
        bootstrap.register(SATONO_DIAMOND, UmaData.createNewUmamusume("satono_diamond", GachaRanking.SR, new int[] {0, 15, 0, 0, 15}));
        bootstrap.register(NICE_NATURE, UmaData.createNewUmamusume("nice_nature", GachaRanking.SR, new int[] {0, 0, 20, 0, 10}));
        bootstrap.register(MAYANO_TOP_GUN, UmaData.createNewUmamusume("mayano_top_gun", GachaRanking.SR, new int[] {0, 20, 0, 10, 0}));
        bootstrap.register(NEO_UNIVERSE, UmaData.createNewUmamusume("neo_universe", GachaRanking.SR, new int[] {0, 0, 0, 0, 30}));
        bootstrap.register(MEISHO_DOTOU, UmaData.createNewUmamusume("meisho_dotou", GachaRanking.SR, new int[] {0, 20, 0, 10, 0}));        
        bootstrap.register(TAIKI_SHUTTLE, UmaData.createNewUmamusume("taiki_shuttle", GachaRanking.SR, new int[] {20, 0, 0, 0, 10}));
        bootstrap.register(CURREN_CHAN_DRESS, UmaData.createNewUmamusume("curren_chan", GachaRanking.SSR, new int[] {10, 0, 20, 0, 10}));
        bootstrap.register(MEJIRO_MCQUEEN, UmaData.createNewUmamusume("mejiro_mcqueen", GachaRanking.SR, new int[] {0, 20, 0, 0, 10}));
        bootstrap.register(COPANO_RICKEY, UmaData.createNewUmamusume("copano_rickey", GachaRanking.SR, new int[] {0, 0, 10, 0, 20}));
        ...
        bootstrap.register(DUMNHEINT,UmaData.createNewUmamusume("dumnheint", GachaRanking.EASTER_EGG, new int[] {20, 20, 10, 0, 0}));
        ...
        bootstrap.register(CHEVAL_GRAND, UmaData.createNewUmamusume("cheval_grand", GachaRanking.SR, new int[] {0, 10, 0, 10, 10}));
        bootstrap.register(VERXINA, UmaData.createNewUmamusume("verxina", GachaRanking.SR, new int[] {10, 0, 0, 10, 10}));
        bootstrap.register(VIVLOS, UmaData.createNewUmamusume("vivlos", GachaRanking.SR, new int[] {10, 0, 10, 0, 10}));
        ...
        bootstrap.register(RHEIN_KRAFT, UmaData.createNewUmamusume("rhein_kraft", GachaRanking.SR, new int[] {0, 0, 15, 15, 0}));
        
        bootstrap.register(BUENA_VISTA, UmaData.createNewUmamusume("buena_vista", GachaRanking.SR, new int[] {0, 0, 15, 15, 0}));
    	
    	bootstrap.register(KS_MIRACLE, UmaData.createNewUmamusume("ks_miracle", GachaRanking.SR, new int[] {15, 0, 0, 15, 0}));
        bootstrap.register(EISHIN_FLASH, UmaData.createNewUmamusume("eishin_flash", GachaRanking.SR, new int[] {0, 0, 10, 0, 20}));
        
        bootstrap.register(MIYA_YOMOGI, UmaData.createNewUmamusume("miya_yomogi", GachaRanking.EASTER_EGG, new int[] {10, 0, 0, 20, 20}));
    	
    	bootstrap.register(YAMANIN_ZEPHYR, UmaData.createNewUmamusume("yamanin_zephyr", GachaRanking.SR, new int[] {10, 0, 0, 10, 10}));
        bootstrap.register(SATONO_CROWN, UmaData.createNewUmamusume("satono_crown", GachaRanking.SR, new int[] {0, 0, 15, 15, 0}));
